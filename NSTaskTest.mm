...
- (void) doIt
{
    ...
    static NSString* pathToTextile = @"/Users/andrep/Code/Skunkworks/RapidWeaver-Plugins/Markup-3.5/MarkupFilters/Textile.pl";
    
    //static char* const bytes = "h1. This is a textile test";
    static NSData* testData = nil;
    if(testData == nil) testData = [[NSData dataWithContentsOfFile:@"/Users/andrep/Desktop/Desktop Items/ET_Bitmap_BMP.cpp"] retain];
    assert(testData != nil);
